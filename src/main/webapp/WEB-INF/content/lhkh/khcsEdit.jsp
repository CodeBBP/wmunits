		...
		<table class="table_all" align="center" border="0" cellpadding="0"
			cellspacing="0" style="margin-top: 0px">
				...
				<tr>
					...
					<td class="td_table_2">
						<input type="hidden" id="parentKhcsId" name="parentKhcsId" value="${pid == null? khcs.pkhcs.id : pid}">
						<input type="text" id="parentKhcsName" readonly="readonly" name="parentKhcsName" class="input_240" value="${pkhcs == null? khcs.pkhcs.khxm : pkhcs}">
					</td>
					<td class="td_table_1">
						<span>占分值：</span>
					</td>
				...
				<tr>
					...
					<td class="td_table_2" colspan="3">
						<textarea style="width:100%;height:150px;" id="xxnr" name="xxnr">${khcs.xxnr}</textarea>
					</td>
				</tr>
			</table>
