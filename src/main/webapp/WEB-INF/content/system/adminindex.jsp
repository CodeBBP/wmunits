        ...
        <ul class="accordion">
          <li><a class="active"><img src="/wmdw/styles/surface/images/cog.png"/>文明创建</a>
            <div style="height: 657px; display: none; overflow: hidden;" class="sub-menu">
              <div class="" onclick="AddTabMenu('dbrw', '/wmdw/dwcl/dbrw', '待办任务', 'document_library.png', 'true');"><img src="/wmdw/styles/surface/images/document_library.png"/>待办任务</div>
              <div class="" onclick="AddTabMenu('dwbb', '/wmdw/dwcl/dwlm', '单位报表', 'report_key.png', 'true');"><img src="/wmdw/styles/surface/images/report_key.png"/>单位报表</div>
              <div class="" onclick="AddTabMenu('zhcx', '/wmdw/dwcl/zhcx', '综合查询', '20130725112128475.png', 'true');"><img src="/wmdw/styles/surface/images/20130725112128475.png"/>综合查询</div>
              <div class="" onclick="AddTabMenu('jfph', '/wmdw/dwcl/jfph', '积分排行', 'document_library.png', 'true');"><img src="/wmdw/styles/surface/images/document_library.png"/>积分排行</div>
              <div class="" onclick="AddTabMenu('cssz', '/wmdw/khcs/list', '参数设置', 'report_key.png', 'true');"><img src="/wmdw/styles/surface/images/report_key.png"/>参数设置</div>
              <div class="" onclick="AddTabMenu('tzgg', '/wmdw/tzgg', '通知公告', '20130725112128475.png', 'true');"><img src="/wmdw/styles/surface/images/20130725112128475.png"/>通知公告</div>
            </div>
          </li>
          ...
          <li><a class=""><img src="${ctx }/styles/surface/images/storage1.png"/>系统管理</a>
            <div style="height: 657px; display: none; overflow: hidden;" class="sub-menu">
              <div class="" onclick="AddTabMenu('yhgl', '/wmdw/security/orgtree/list', '用户管理', '20130717121539279.png', 'true');"><img src="${ctx }/styles/surface/images/20130717121539279.png"/>用户管理</div>
              <div class="" onclick="AddTabMenu('bmgl', '/wmdw/security/org', '部门管理', 'newspaper_go.png', 'true');"><img src="${ctx }/styles/surface/images/newspaper_go.png"/>部门管理</div>
              <div class="" onclick="AddTabMenu('jsgl', '/wmdw/security/role', '角色管理', 'drive_go.png', 'true');"><img src="${ctx }/styles/surface/images/drive_go.png"/>角色管理</div>
              <div class="" onclick="AddTabMenu('qxgl', '/wmdw/security/authority', '权限管理', 'print.png', 'true');"><img src="${ctx }/styles/surface/images/print.png"/>权限管理</div>
              <div class="" onclick="AddTabMenu('zygl', '/wmdw/security/resource', '资源管理', 'drive_go.png', 'true');"><img src="${ctx }/styles/surface/images/drive_go.png"/>资源管理</div>
              <div class="" onclick="AddTabMenu('cdgl', '/wmdw/security/menu', '菜单管理', 'print.png', 'true');"><img src="${ctx }/styles/surface/images/print.png"/>菜单管理</div>
              <div class="" onclick="AddTabMenu('cdgl', '/wmdw/config/dictionary', '配置管理', 'print.png', 'true');"><img src="${ctx }/styles/surface/images/print.png"/>配置管理</div>
            </div>
          </li>
        </ul>
      </div>
