...
<body onload="MyLoad()">
<div id="switchpic"><a href="javascript:switchLayout()"><img src="${ctx}/styles/images/switch_left.gif" alt="隐藏左侧导航栏"
                                                             id="arrow"/></a></div>
</body>
</html>
