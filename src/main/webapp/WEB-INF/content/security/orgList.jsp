	...
	<form id="mainForm" action="${ctx}/security/org?lookup=${lookup }" method="get">
		...
		<table class="table_all" align="center" border="0" cellpadding="0"
			...
			<tr>
				...
				<td class="td_table_2">
					<input type="text" class="input_240" name="filter_LIKES_zzjgmc" value="${param['filter_LIKES_zzjgmc']}"/>
				</td>
			</tr>
		</table>
		...
		<table class="table_all" align="center" border="0" cellpadding="0"
			...
			<c:forEach items="${page.result}" var="org">
				<tr>
					...
					<c:otherwise>
						<a href="javascript:void(0)" class="btnSelect" title="选择" onclick="bringback('${org.id}','${org.zzjgmc }')">选择</a>
					</c:otherwise>
					</c:choose>
					</td>
				</tr>
