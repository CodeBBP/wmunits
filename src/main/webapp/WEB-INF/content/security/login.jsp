...
<div class="index-loginbg">
	<div class="index-login" >
		<div id="loginDIvBg" class="ui-logindivbg" style="background-image:url(${ctx}/styles/assets/bestpay/inside-main/loading.gif)">
			...
			<div id="loginTitle" class="ui-logindiv-title" style="display:none">
				<ul>
					<li class="logindiv-sel title-left" name="Account">
						<span>用户登录</span>&nbsp;&nbsp;&nbsp;&nbsp;<font color="red" size="2px" id='ListMsg'>${error}</font>
					</li>
				</ul>
			</div>
		</div>
			...
			<div class="ui-logindiv-main mob-login" id="Account" >
				<ul id="Teltrue">
					<form id="telLoginForm" name="telLoginForm" method="post">
						...
						<li>
              				<input type="text" style="width:130px" name="vcode" id="txtCheckCode" value="" onfocus="$(this).prev('span').hide()" onBlur="if(!value){$(this).prev('span').show()}"  />
				...
				<ul id="Telfalse" style="display:none" >
					<form id="telFalseForm" name="telFalseForm" method="post">
						...
						<li id="othercode">
							...
							<span name="codeflagSpan" id="othercodeFlagSpan" class="ui-Securityimage" style="display:none">
				...
				<ul >
					<form id="cardForm" name="cardForm" method="post">
						...
						<li id="cardcode">
							...
							<span name="codeflagSpan" id="cardcodeFlagSpan" class="ui-Securityimage" style="display:none">
